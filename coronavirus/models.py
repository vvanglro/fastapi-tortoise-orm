...
class City(BaseModel):
    province = fields.CharField(max_length=100, unique=True, nullable=False, index=True, description='省/直辖市')
...
class Data(BaseModel):
    ...
    now_confirmed = fields.BigIntField(default=0, nullable=False, description='现有确诊数量')
    confirmed = fields.BigIntField(default=0, nullable=False, description='累计确诊数量')
    deaths = fields.BigIntField(default=0, nullable=False, description='累计死亡数量')
    recovered = fields.BigIntField(default=0, nullable=False, description='累计痊愈数量')
