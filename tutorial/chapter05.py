...
async def dependency01(commons: dict = Depends(common_parameters)):  # 使用Depends将common_parameters方法用作依赖 代码的复用
    return commons
...
fake_items_db = [{"item_name": "Foo"}, {"item_name": "Bar"}, {"item_name": "Hulk"}]
...
@app05.get('/depandency_in_path_operation',
